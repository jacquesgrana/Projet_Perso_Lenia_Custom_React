export default class CanvasConfig {
    ...
    public static readonly BRUSH_STROKE_SMALL_WIDTH = 1;
    public static readonly BRUSH_STROKE_MEDIUM_WIDTH = 3;
    public static readonly BRUSH_STROKE_WIDTH = 4;
    public static readonly BRUSH_STROKE_LARGE_WIDTH = 6;
    public static readonly BRUSH_STROKE_MEDIUM_COLOR = "rgb(0, 0, 0)";
